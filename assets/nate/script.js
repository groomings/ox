const catId = '1410026790256377936';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    pgpBtn.addEventListener('click', () => window.open('https://pomf2.lain.la/f/t8yazqpk.txt', '_blank'));
